...
|---|---|---|---|
| 1 | Site talepleri otomatik düşsün, müşteri açılsın | ✅ | 21 Eyl'de iletim geri açıldı. Eşleştirme **telefonla** (isimle değil) — daha güvenli; isimle istenirse yanlış birleştirme riski konuşulmalı |
