...
export const REPORTS: ReportDef[] = [
  ...
  // PAKET G: Finans raporu yalnız bayrak açıkken kayıtlı (FinansRaporu bileşeni silinmedi).
  ...(features.finance ? [{ key: 'finans', label: 'Finans', icon: Wallet, permission: 'finance.view', Component: FinansRaporu }] : []),
