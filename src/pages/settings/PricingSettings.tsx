  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-lg border border-border bg-card p-5">
        ...
        <p className="mb-3 text-xs text-text-muted">min_quantity ≤ adet olan en büyük kademe geçerli. Güncel: 50→%40 · 51→%30 · 251→%20 (tam 250 adet %30). Teklif hazırlarken elle girilen oran kademeyi ezer.</p>
