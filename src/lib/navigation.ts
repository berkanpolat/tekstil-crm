...
export interface NavItem {
  ...
  financeOnly?: boolean
  /** Özellik bayrağı — kapalıysa menü+rota gizli (PAKET G). */
  feature?: FeatureKey
}
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Teklifler', path: '/teklifler', icon: FileText, description: 'Fiyat teklifleri, sürümler ve sonuç takibi.', feature: 'quotesPanel' },
  { label: 'Numuneler', path: '/numuneler', icon: Shirt, description: 'Numune üretim, revizyon ve onay takibi.', feature: 'samplesPanel' },
  { label: 'Siparişler', path: '/siparisler', icon: ClipboardList, description: 'Onaylı siparişlerin üretim ve teslim süreci.', feature: 'ordersPanel' },
  ...
  { label: 'Finans', path: '/finans', icon: Wallet, description: 'Cari hesaplar, ödemeler ve finansal takip.', financeOnly: true, feature: 'finance' },
  { label: 'Görevler', path: '/gorevler', icon: ListTodo, description: 'Görevler, koordinasyon ve otomatik öneriler.', feature: 'tasks' },
  { label: 'Hedefler', path: '/hedefler', icon: Target, description: 'Hedefler ve gerçekleşen ilerleme.', feature: 'goals' },
